...
let s:cdCursorDarkDark = {'gui': '#282828', 'cterm': s:cterm01, 'cterm256': '235'}
...
call <sid>hi('StatusLineNC', s:cdGray, s:cdLeftDark, 'none', {})
call <sid>hi('TabLine', s:cdGray, s:cdTabOther, 'none', {})
